...
describe("POST /delete-user", function () {
    it("3.Verify Failed Delete User without Authorization", async function () { 
        const response = await request_url 
            .del("/delete-user")
    ...
    it("4.Verify Failed Delete User with Invalid Password", async function () { 
        const response = await request_url 
            .del("/delete-user")
    ...
    it("5.Verify Failed Delete User with Empty String", async function () { 
        const response = await request_url 
            .del("/delete-user")
            .set({ Authorization: authorize_value })
            .send({ password: ""});
    ...
    it("6.Verify Failed Delete User with Integer value", async function () { 
        const response = await request_url 
            .del("/delete-user")
            .set({ Authorization: authorize_value })
            .send({ password: 1});
    ...
    it("7.Verify Failed Delete User with Max Character", async function () {
    ...
    it("8.Verify Failed Delete User with Older Authorization", async function () { 
        const response = await request_url 
            .del("/delete-user")
    ...
    it("9.Verify Failed Delete User with Empty Authorization", async function () { 
        const response = await request_url 
            .del("/delete-user")
            .set({ Authorization: '' })
            .send({ password: "sman60jakarta"});
    ...
    it("10.Verify Failed Delete User with Bearer Authorization and valid value", async function () { 
        const response = await request_url 
            .del("/delete-user")
            .set({ Authorization: authorize_value })
    ...
    it("11.Verify Failed Delete User with Bearer Authorization and valid value", async function () { 
        const response = await request_url 
            .del("/delete-user")
    ...
    it("12.Verify Failed Delete User with Bearer Authorization and wrong value", async function () { 
        const response = await request_url 
            .del("/delete-user")
    ...
    it("13.Verify Failed Delete User with GET Request", async function () { 
        const response = await request_url 
            .get("/delete-user")
            .set({ Authorization: authorize_value })
            .send({ password: random_text});
    ...
    it("14.Verify Failed Delete User with POST Request", async function () { 
        const response = await request_url 
            .post("/delete-user")
            .set({ Authorization: authorize_value })
            .send({ password: random_text});
    ...
    it("15.Verify Failed Delete User with PATCH Request", async function () { 
        const response = await request_url 
            .patch("/delete-user")
            .set({ Authorization: authorize_value })
            .send({ password: random_text});
    ...
    it("16.Verify Failed Delete User with empty body only dictionary", async function () { 
        const response = await request_url 
            .del("/delete-user")
            .set({ Authorization: authorize_value })
            .send({});
    ...
    it("17.Verify Failed Delete User with xx-www-form-urlencoded as Body", async function () { 
        const response = await request_url 
            .del("/delete-user")
    ...
    it("18.Verify Failed Delete User with xx-www-form-urlencoded as Body", async function () { 
        const response = await request_url 
            .del("/delete-user")
            .type('form')
            .set({ Authorization: authorize_value })
    ...
    it("19.Verify Success Delete User", async function () { 
        const response = await request_url 
            .del("/delete-user")
            .set({ Authorization: authorize_value })
            .send({ password: random_text});
